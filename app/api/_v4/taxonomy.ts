...
export const TAXONOMY: ClusterDef[] = [
  ...
  },
  {
    ...
    example_phrases: ["dashboard", "reporting", "weekly report", "monthly report", "track", "tracker", "scorecard"],
  },
  {
    ...
    example_phrases: ["market research", "competitive analysis", "swot", "industry research", "due diligence"],
  },
  {
