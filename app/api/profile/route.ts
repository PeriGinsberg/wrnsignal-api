...
const PROFILE_SELECT =
  "id, user_id, email, name, job_type, target_roles, target_locations, preferred_locations, timeline, resume_text, profile_text, profile_structured, profile_version, profile_complete, is_coach, coach_org, updated_at"
