...
// lib/jobfit-family-inference.ts. Previously this file had its own
// ~150-line copy that had drifted out of sync with profile-intake's
// version, causing real bugs (Josselyn CoS/HRBP mapping, Lily
// Engineering truncation, Finance family duplicated checks, adapter
