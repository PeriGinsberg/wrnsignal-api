...
const CAPABILITY_RULES: CapabilityRule[] = [
  ...
  {
    // Amusement park / attraction / ride operation. Built for service-
    // industry early-career roles (theme parks, family entertainment
    // centers, water parks, fairs). Catches profile experience like
    // "operated amusement park attractions in accordance with safety
    // protocols" and JD requirements like "operates assigned ride",
    // "daily inspections of assigned ride", "ride safety", etc.
    // Phrases anchored on compound forms to avoid generic matches
    // (e.g., "safety" alone, "boarding" alone — those hit too broadly).
    key: "ride_attraction_operation",
    label: "amusement park ride and attraction operation",
    kind: "execution",
    functionTag: "operations_general",
    profilePhrases: [
    ...
    jobPhrases: [
      ...
      "water park",
      "iroc",
      "international ride operator certification",
      "passengers exit safely",
      "boarding, securing passengers",
      "monitoring and attending to park",
    ],
    adjacentKeys: [
