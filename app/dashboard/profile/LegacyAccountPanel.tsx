...
// TEMPORARY (redesign step 6, 2026-08-04). This is the OLD /dashboard page,
// moved here whole rather than deleted, because it holds three capabilities
// with no other home yet: resume PERSONAS (create, edit, upload, set default,
// delete), the coach recommendation responses, and the 7-day refund panel.
//
// The new Dashboard is a stateful "what needs you" home and none of this
// belongs on it. The designed home is My Profile > Resume and My Profile >
// Account, which is the next screen. Moving it here keeps it reachable and on
// a page that is still DARK, so it stays internally coherent instead of
// rendering dark cards on the light ground.
//
// REMOVE when My Profile absorbs Resume and Account. Nothing here was
// restyled; it is the same component at a new address.
