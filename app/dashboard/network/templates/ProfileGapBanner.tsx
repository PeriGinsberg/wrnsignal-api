...
//
// SOFT, never blocking. The page stays fully usable, and nobody is locked out of
...
export function ProfileGapBanner({ profile }: { profile: Record<string, unknown> | null }) {
  // No profile loaded yet is not the same as an empty one, so say nothing rather
