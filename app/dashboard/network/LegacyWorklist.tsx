...
// Network Tracker — the old DAILY WORKLIST, no longer routable.
//
// This was /dashboard/network, the networking area's front door. The build plan
// drops it: the Dashboard is the single "what needs you" surface, and a
// per-area worklist duplicates it with a second, dark, differently-worded
// answer to the same question. /dashboard/network now redirects to Contacts.
//
// KEPT, not deleted, because it is the only reader of GET /api/network/worklist
// and of DashboardSection, and because the Dashboard's nudges were built from
// this logic rather than replacing it wholesale. It renders nowhere today.
// REMOVE once the Dashboard demonstrably covers every case this did.
...
export function LegacyWorklist() {
