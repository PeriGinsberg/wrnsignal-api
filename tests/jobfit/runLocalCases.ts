...
import type { EvalOutput, LocationConstraint } from "../../app/api/jobfit/signals"
...
function runCase(testCase: RegressionCase) {
  ...
  const renderInput: EvalOutput = {
    ...
    next_step: "",
    location_constraint: (
      testCase.profileOverrides?.locationPreference?.constrained ? "constrained" : "not_constrained"
